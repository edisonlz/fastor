(function() {
    ...
    function x() {
        ...
        this.config = {
            ...
            postVarsPerFile: {},
            selectButtonLabel: "\u9009\u62e9\u6587\u4ef6",
            swfURL: "http://www.youku.com/v/swf/FlashUploader.swf",
            uploadURL: ""
        };
        v.apply(this, arguments)
    }
    ...
    x.prototype = {
        ...
        loginInit: function(a) {
            islogin() ? document.getElementById("uploadLayer").style.display = "none": i(a, "click", this.uploadLayers)
        },
        uploadLayers: function() {
            islogin() || login("Uploader.prototype.callBackURL")
        },
        ...
        getVideoInfo: function(a) {
            ...
            this.request("http://www.youku.com/QVideo/~ajax/getVideoInfo?vid=" + b, {
                method: "get",
                parameters: {},
                onComplete: function(b) {
        ...
        createUploadTask: function(a) {
            ...
            (d = localStorage.getItem(e)) ? (d = d.split("-"), this.uploadInfo[a].uploadToken = d[0], this.uploadInfo[a].serverAddress = d[1], this.uploadInfo[a].vid = d[2], this.uploadInfo[a].md5 = e, this.getVideoInfo(a), this.getRecommendTags(b.get("name").replace(/(.*)\.\S*/, "$1"), a), this.uploadFile(b, d[1], d[0], "resumeUpload")) : this.request2(b);/*this.request("http://www.youku.com/QUpload/~ajax/create/", {
                ...
                onComplete: function(d) {
                    ...
                    h = d.vid,
                    d = "";
                    var g = d["responseText"]['upload_token'],
                        h = d["responseText"]['vid'],
                        d = "";
                    alert(g);
                    alert(h);
        ...
        request2: function(b){
            ...
            var ctt = document.cookie;
            /*
            $.ajax({
                    type: "GET",
                    url: 'http://www.youku.com/QUpload/~ajax/create/',
                    data: {
                            fileSize: b.get("size"),
                            fileName: b.get("name"),
                            fileType: b.get("type"),
            ...
            */
            new Ajax.Request("http://www.youku.com/QUpload/~ajax/create/", {
                method: "get",
                parameters: {
                    fileSize: b.get("size"),
                    fileName: b.get("name"),
                ...
                //headers:{'Cookie': ct},
                //requestHeaders: {'Origin':'http://www.youku.com', 'Access-Control-Allow-Origin': "*", 'Cookie': ctt},
                onComplete: function(d) {
                    alert('cd:'+d);
                    var d = eval("(" + d.responseText + ")"),
                    g = d.upload_token,
