...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=video_url%>video.css\" />" +
            ...
            "<span tabSrc=\"video\" class=\"edui-video-focus\"><%=lang_tab_insertV%>（目前只支持插入一个视频）</span>" +
            "</div>" +
            "<div id=\"eduiVideoTabBodys\" class=\"edui-video-tabbody\">" +
            "<div id=\"eduiVideoPanel\" class=\"edui-video-panel\">" +
            "<table><tr><td><label for=\"eduiVideoUrl\" class=\"edui-video-url\"><%=lang_video_url%></label></td><td><input id=\"eduiVideoUrl\" type=\"text\" placeholder=\"请输入视频网址(目前只支持youku单视频网址)\"><input id=\"eduiVideoOriginalUrl\" type=\"text\" style=\"display:none\"></td></tr></table>" +
        ...
        initController: function( lang ){
            ...
            if(img && img.className == "edui-faked-video"){
                ...
                $("#eduiVideoOriginalUrl", me.$widget)[0].value = url;
        ...
        insertSingle: function(){
            ...
            var original_url=$("#eduiVideoOriginalUrl", me.$widget)[0].value;
        ...
        buttons: {
            ok: {
                exec: function( editor, $w ){
                    ...
                    $("#eduiVideoOriginalUrl").val($("#eduiVideoUrl").val());
